...
def calculate_ci():
    ...
    CI = principal * (pow((1 + 100 / 100), time))
...
if __name__ == "__main__":
    ...
    label1 = Label(root, text = "Principal Amount(Rs) :",
                   fg = 'black', bg = 'blue')
    label2 = Label(root,text = "Rate(%) : ", fg = 'black', bg = 'blue')
    label3 = Label(root,text = "Time(years) : ",fg = 'black', bg = 'blue')
    label4 = Label(root,text = "Amount : ",fg = 'black', bg = 'blue')
